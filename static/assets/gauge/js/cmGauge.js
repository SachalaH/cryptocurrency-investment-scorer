...
(function ($, window, document, undefined) {
  ...
  Gauge.prototype = {
    ...
    updateGauge: function (el) {
      ...
      var color =
        Gauge.prototype.colors[
          Math.floor(percentage / Gauge.prototype.partSize)
        ];
      color =
        color || Gauge.prototype.colors[Gauge.prototype.colors.length - 1];
      el.css("transform", "rotate(" + (1.8 * percentage - 90) + "deg)");
      el.parent().removeClass(Gauge.prototype.colors.join(" ")).addClass(color);
    },
  };
